...
\begin{enumerate}
  \item La superficie del escenario esta hecha de tableros de MDF negro (Ver \figref{course}). Cada tablero es de 120x120cm. Entre cada tablero puede existir un desnivel máximo de 5mm. No se aceptarán reclamos sobre el agarre de la superficie.
